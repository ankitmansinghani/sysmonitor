...
dist: 
	@test -d .tmp/demo1.0.0 || mkdir -p .tmp/demo1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/demo1.0.0/ && $(COPY_FILE) --parents demoapp.h .tmp/demo1.0.0/ && $(COPY_FILE) --parents main.cpp demoapp.cpp .tmp/demo1.0.0/ && $(COPY_FILE) --parents demoapp.ui .tmp/demo1.0.0/ && (cd `dirname .tmp/demo1.0.0` && $(TAR) demo1.0.0.tar demo1.0.0 && $(COMPRESS) demo1.0.0.tar) && $(MOVE) `dirname .tmp/demo1.0.0`/demo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/demo1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_demoapp.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_demoapp.cpp
moc_demoapp.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
